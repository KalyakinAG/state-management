...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РаботаСФормойКлиентСервер.Элемент(ЭтотОбъект, Модель,,, 
		"ТолькоПросмотр,Номер,ПриходРасход,СуммаДокумента,ВалютаДокумента,ДатаНачала,
		|Контрагент,ВидОперацииБюджетирование,
		|ПометкаУдаления,Проведен,ЭтоНовый");

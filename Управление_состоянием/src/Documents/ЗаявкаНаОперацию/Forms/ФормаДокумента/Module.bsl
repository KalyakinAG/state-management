...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РаботаСМодельюКлиентСервер.Связь(ЭтотОбъект, Модель, "ВалютаВзаиморасчетов", "ДоговорКонтрагента", "ДоговорКонтрагента");
	...
	РаботаСМодельюКлиентСервер.Связь(ЭтотОбъект, Модель, "СуммаВзаиморасчетов", "СуммаДокумента", "СуммаДокумента");
	РаботаСМодельюКлиентСервер.Связь(ЭтотОбъект, Модель, "СуммаВзаиморасчетов", "КроссКурс", "КроссКурс");
	РаботаСМодельюКлиентСервер.Связь(ЭтотОбъект, Модель, "ДвиженияОперации.СуммаВзаиморасчетов", "ДвиженияОперации.Сумма", "Сумма");
	РаботаСМодельюКлиентСервер.Связь(ЭтотОбъект, Модель, "ДвиженияОперации.СуммаВзаиморасчетов", "КроссКурс", "КроссКурс");
	РаботаСМодельюКлиентСервер.Связь(ЭтотОбъект, Модель, "Комментарий", "_Комментарий", "Комментарий");

	РаботаСМодельюКлиентСервер.Связь(ЭтотОбъект, Модель, "КроссКурс", "Дата", "Дата");
	РаботаСМодельюКлиентСервер.Связь(ЭтотОбъект, Модель, "КроссКурс", "ВалютаДокумента", "ВалютаДокумента");
	РаботаСМодельюКлиентСервер.Связь(ЭтотОбъект, Модель, "КроссКурс", "ВалютаВзаиморасчетов", "ВалютаВзаиморасчетов");

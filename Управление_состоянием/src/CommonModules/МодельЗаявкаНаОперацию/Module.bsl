Функция СвойстваЭтаФорма(Свойства, Параметры) Экспорт
	Перем Представление, Статус, Заголовок;
...
Процедура ПриИзмененииБанковскийСчет(Контекст, Объект, ДанныеСтроки, Реквизит, ИзмененныеРеквизиты, РассчитанныеРеквизиты) Экспорт

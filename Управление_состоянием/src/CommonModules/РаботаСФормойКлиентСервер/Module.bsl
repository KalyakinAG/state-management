...
//		#КонецЕсли
		...
		Для Каждого ЭлементСвойства Из Свойства Цикл
			Если ЭлементСвойства.Ключ = "ТекущаяСтраница" Тогда
				ОбщийКлиентСервер.УстановитьЗначение(Элемент[ЭлементСвойства.Ключ], Элементы[ЭлементСвойства.Значение]);
			...
			ИначеЕсли ЭлементСвойства.Ключ = "ТекущийЭлемент" Тогда
				Контекст.ТекущийЭлемент = Элементы[ЭлементСвойства.Значение];
			Иначе
				ОбщийКлиентСервер.УстановитьЗначение(Элемент[ЭлементСвойства.Ключ], ЭлементСвойства.Значение);
			КонецЕсли;
		КонецЦикла;

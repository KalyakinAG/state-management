...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	РаботаСФормойКлиентСервер.Элемент(ЭтотОбъект, Модель, Элементы.НалоговыеРеквизиты,, 
	...
	РаботаСМоделью.Инициализировать(ЭтотОбъект, Модель);//  Связывание формы и модели
КонецПроцедуры

&НаКлиенте
Процедура ПриОткрытии(Отказ)
	// Отображение состояния формы в контексте клиента, 
	// т.к. некоторые параметры формы должны восстановиться из хранилища сохраненных настроек
	ОбновитьФорму();
КонецПроцедуры
